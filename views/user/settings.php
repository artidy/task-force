...
<div class="my-profile-form">
    ...
    <div class="photo-editing">
        <div>
            ...
            <img class="avatar-preview" alt="Аватар пользователя" src="<?= Html::encode($user->avatar_path); ?>" width="83">
        </div>
    ...
    <div class="half-wrapper">
        <?= $form->field($user, 'phone_number')->input('tel'); ?>
        <?= $form->field($user, 'telegram'); ?>
    </div>
    <?= $form->field($user, 'description')->textarea(); ?>

    <div class="form-group">
        <?= $form->field($user, 'userSpecializations')->
            checkboxList(array_column(Specializations::find()->
            all(), 'title', 'id'),
